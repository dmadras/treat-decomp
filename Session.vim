...
silent only
cd ~/projects/treat-decomp
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 src/codebase/dataset.py
badd +27 src/dataproc/make_synth_dataset_basic.py
badd +10 src/codebase/utils.py
badd +4 src/codebase/metrics.py
badd +45 ~/projects/causal-fairness/src/dataproc/create_synth_data.py
badd +1 src/dataproc/make_data_splits.py
badd +0 ~/projects/causal-fairness/src/dataproc/create_data_splits.py
badd +0 src/dataproc/create_data_splits.py
badd +0 src/run_make_synth_dataset_basic.py
argglobal
silent! argdel *
argadd src/codebase/dataset.py
set stal=2
edit src/codebase/dataset.py
...
silent! normal! zE
let s:l = 1 - ((0 * winheight(0) + 55) / 110)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
1
normal! 0
tabedit src/run_make_synth_dataset_basic.py
set splitbelow splitright
wincmd _ | wincmd |
split
1wincmd k
...
wincmd t
set winheight=1 winwidth=1
exe '1resize ' . ((&lines * 54 + 55) / 111)
exe '2resize ' . ((&lines * 53 + 55) / 111)
argglobal
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
...
wincmd w
argglobal
edit src/dataproc/make_synth_dataset_basic.py
let s:cpo_save=&cpo
set cpo&vim
nmap <buffer> [c <Plug>GitGutterPrevHunk
nmap <buffer> \hp <Plug>GitGutterPreviewHunk
...
exe '1resize ' . ((&lines * 54 + 55) / 111)
exe '2resize ' . ((&lines * 53 + 55) / 111)
tabedit src/dataproc/create_data_splits.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 23 - ((22 * winheight(0) + 54) / 109)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
23
